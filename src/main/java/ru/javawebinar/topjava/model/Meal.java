...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.SELECT, query = "SELECT m FROM Meal m WHERE m.id=:id AND m.user.id =:user_id"),
        @NamedQuery(name = Meal.SELECT_ALL, query = "SELECT m FROM Meal m WHERE m.user.id =:user_id ORDER BY m.dateTime DESC"),
...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String SELECT_ALL = "Meal.selectAll";
    public static final String BETWEEN = "Meals.getBetween";
